            ...
            const fetchNews = {
                "NewsFeed.useEffect.fetchNews": async ()=>{
                    ...
                    try {
                        ...
                        const topHeadlines = response.data.data.slice(0, 3).map({
                            "NewsFeed.useEffect.fetchNews.topHeadlines": (article)=>article.title
                        }["NewsFeed.useEffect.fetchNews.topHeadlines"]);
...
var _c, _c1;
__turbopack_context__.k.register(_c, "NewsSkeleton");
__turbopack_context__.k.register(_c1, "NewsFeed");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/components/ChartSkeleton.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function Dashboard() {
    ...
    const addToWatchlist = async (symbol)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("https://fyntra-backend.onrender.com/api/watchlist/add", {
                userEmail: userId,
                symbol
            });
            setWatchlist((prev)=>[
    ...
    const removeFromWatchlist = async (symbol)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("https://fyntra-backend.onrender.com/api/watchlist/remove", {
                userEmail: userId,
                symbol
            });
    ...
    const fetchAISummary = async (symbol, news, ratios)=>{
        setAiLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("https://fyntra-backend.onrender.com/api/ai/summary", {
                ticker: symbol,
                news,
                ratios
            });
...
_s(Dashboard, "0nRgtayBq1/480uozqBOy22cVSg=", false, function() {
    return [
